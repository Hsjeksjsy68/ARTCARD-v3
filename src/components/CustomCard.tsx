              ...
              {imageUrl && (
                <div className="mt-3 space-y-3 bg-neutral-50 p-4 border-2 border-black">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div>
                      <div className="flex items-center justify-between mb-1">
                        <label className="text-[10px] font-black uppercase text-neutral-500">HORIZONTAL (X)</label>
                        <span className="text-xs font-mono font-black">{imageOffsetX}px</span>
                      </div>
                      <input type="range" min="-300" max="300" value={imageOffsetX} onChange={e => setImageOffsetX(Number(e.target.value))} className="w-full accent-black" />
                    </div>
                    <div>
                      <div className="flex items-center justify-between mb-1">
                        <label className="text-[10px] font-black uppercase text-neutral-500">VERTICAL (Y)</label>
                        <span className="text-xs font-mono font-black">{imageOffsetY}px</span>
                      </div>
                      <input type="range" min="-300" max="300" value={imageOffsetY} onChange={e => setImageOffsetY(Number(e.target.value))} className="w-full accent-black" />
                    </div>
                  </div>
                </div>
              )}
